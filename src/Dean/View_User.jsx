...
export default function View_User({ user }) {
          ...
          <div className="space-y-5">
            ...
            <InfoCard icon={User} title="Personal Information">
              <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                ...
                <InfoItem 
                  label="Gender" 
                  value={sampleUser.gender} 
                  icon={Users} 
                />
                <InfoItem 
                  label="Date of Birth" 
                  value={sampleUser.dob} 
                  icon={Calendar} 
                />
                <InfoItem 
                  label="Contact Number" 
                  value={sampleUser.contact} 
                  icon={Phone} 
                />
              </div>
            </InfoCard>
