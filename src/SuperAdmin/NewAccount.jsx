                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="w-full">
                      ...
                      <div className="relative w-full">
                        ...
                        />
                        <Calendar size={20} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none" />
                      </div>
                ...
                {step < 2 ? (
                  ...
                  <button
                    ...
                    className={`px-6 py-2 rounded-md text-white ${
                      loading ? "bg-gray-400 cursor-not-allowed" : "bg-[#2B7811] hover:opacity-90"
                    }`}
                  >
                    {loading ? (
